...
#' @param cloud.dates Dates for the daily mean cloud cover data.
#' @param sun.dates Dates for the daily total sunshine duration data.
#' @param sun_rel.dates Dates for the daily relative sunshine duration data.
